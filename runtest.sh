...
accelerate launch --main_process_port 29501 --num_processes 6 main.py --tasks csqa --model meta-llama/Meta-Llama-3-8B --shotfive --cats --check --kernel_size 16 --spr 0.5 --thr 0.1  --widthtree 1 
