...
accelerate launch --main_process_port 29501 --num_processes 2 main.py --tasks csqa --model meta-llama/Llama-2-13b-chat-hf --shotfive --griffin --check --kernel_size 12 --spr 0.5 --thr 0.05 --widthtree 4 
