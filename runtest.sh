...
accelerate launch --main_process_port 29501 --num_processes 8 main.py --tasks strategyqa --model meta-llama/Llama-2-7b-chat-hf --shotfive --griffin --check --kernel_size 16 --spr 0.4 --thr 0.001 --widthtree 1 
